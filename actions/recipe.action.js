...
"nutrition": {
  "calories": "number only (example: 350)",
  "protein": "number with g only (example: 30g)",
  "carbs": "number with g only (example: 5g)",
  "fat": "number with g only (example: 22g)"
},
  "tips": [
...
- Do NOT use words like "approximately", "around", or "about"
- Return clean numeric values only
- No extra text inside nutrition fields
`;
